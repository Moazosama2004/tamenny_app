...
class S {
  ...
  String get welcomeToTheTAMENNY {
    return Intl.message(
      'Welcome to the TAMENNY',
      name: 'welcomeToTheTAMENNY',
      desc: '',
      args: [],
    );
  }
  ...
  String get yourMindfulMentalHealthAICompanion {
    return Intl.message(
      'Your mindful mental health AI companion for everyone, anywhere 🍃',
      name: 'yourMindfulMentalHealthAICompanion',
      desc: '',
      args: [],
    );
  }
